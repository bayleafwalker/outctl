...
digest. The pinned spool root is synced after first creating the receipt
directory and again after receipt publication, before raw unlink is permitted.
Strict retrieval and index rebuild require both records to reconcile.
